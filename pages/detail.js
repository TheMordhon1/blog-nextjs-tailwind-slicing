...
const detail = () => {
  return (
    <>
      <Head>
        <title>Librarus | Detail Post</title>
      </Head>
      <Layout>
        <div className="mx-auto w-full sm:w-6/12 flex flex-col  items-center">
          <PostMetaTitle
            category="UI Design"
            date="July 2, 2021"
        ...
        <div className="mx-auto w-full sm:w-10/12 my-10">
          <img
        ...
        <div className="mx-auto w-full sm:w-8/12 leading-relaxed">
